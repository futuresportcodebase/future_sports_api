...
from ..functions.web3_functions import fetch_assets_by_owner, fetch_assets_images_by_wallet_address
...
#     """
#     return fetch_all_token_accounts(sol_wallet)

@router.get("/get_assets_images")
async def get_assets_images(wallet_address: str = Query(..., description="Solana Wallet Address"),
    ...
    """
    image_links = fetch_assets_images_by_wallet_address(wallet_address, interface_filter)
